...
func (l *ListInfo) ToGFWList() []byte {
	...
	gfwlistBytes = append(gfwlistBytes, []byte("! HomePage: https://github.com/shiharuharu/domain-list-custom\n")...)
	gfwlistBytes = append(gfwlistBytes, []byte("! GitHub URL: https://raw.githubusercontent.com/shiharuharu/domain-list-custom/release/gfwlist.txt\n")...)
	gfwlistBytes = append(gfwlistBytes, []byte("! jsdelivr URL: https://cdn.jsdelivr.net/gh/shiharuharu/domain-list-custom@release/gfwlist.txt\n")...)
